...
/* Détermine quelle vue afficher à partir de l'URL actuelle (#panier, #membre…),
   ...
   Appelée au chargement initial ET à chaque changement d'URL (retour navigateur). */
function applyRouteFromHash() {
  ...
  // URL racine : si déjà connecté, direction son espace ; sinon page d'accueil
  showView(loggedIn ? (currentProfile.role === 'admin' ? 'admin' : 'membre') : 'landing');
}
