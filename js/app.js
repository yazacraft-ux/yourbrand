...
function exitPopupClaim() { closeExitPopup(); addToCart(2); }
...
function saveTextes() {
  st('banner-text', document.getElementById('et-banner').value);
  st('hero-badge', document.getElementById('et-badge').value);
  st('hero-sub', document.getElementById('et-hero-sub').value);
  st('hero-cta1', document.getElementById('et-cta1').value);
  st('hero-cta2', document.getElementById('et-cta2').value);
  st('cta-title', document.getElementById('et-cta-title').value);
  st('cta-sub', document.getElementById('et-cta-sub').value);
  alert('Textes landing mis à jour ✓');
}

function saveCartTexts() {
  st('cart-step-lbl', document.getElementById('ct-step').value);
  st('cart-page-title', document.getElementById('ct-title').value);
  st('cart-btn-txt', document.getElementById('ct-btn-txt').value);
  st('cart-guarantee-txt', document.getElementById('ct-guarantee').value);
  st('success-title', document.getElementById('ct-success-title').value);
...
function saveChatWidget() {
  st('cw-title', document.getElementById('cw-title-input').value);
  st('cw-sub', document.getElementById('cw-sub-input').value);
  var e = document.getElementById('cw-email').value;
  var b = document.getElementById('cw-btn-txt').value;
  var btn = document.getElementById('chat-contact-btn');
  if (btn) { btn.textContent = b; btn.href = 'mailto:' + e; }
...
function saveMaintenance() {
  st('maint-icon', document.getElementById('maint-icon-input').value);
  st('maint-title', document.getElementById('maint-title-input').value);
  st('maint-sub', document.getElementById('maint-sub-input').value);
  st('maint-badge-txt', document.getElementById('maint-badge-input').value);
...
function saveSettings() {
  ...
  S.adminPass = document.getElementById('s-admin-pass').value;
  S.membrePass = document.getElementById('s-membre-pass').value;
...
function buildAdminTabs() {
  ...
  '<div id="atab-settings" class="admin-tab">' +
    ...
    '<div class="adsec"><div class="edit-section">' +
      ...
      '<div class="fr2"><div class="ef"><label class="fl">Mot de passe admin</label><input class="fi" type="password" id="s-admin-pass" value="admin123"></div><div class="ef"><label class="fl">Mot de passe membre</label><input class="fi" type="password" id="s-membre-pass" value="membre123"></div></div>' +
