...
var S = {
  ...
  footer: "© 2025 Jenafans · Tous droits réservés",
  ...
  heroTitleL1: "Le guide qui va",
  heroTitleHighlight: "changer ta façon",
  heroTitleL2: "de voir les choses."
};
...
var DL = {
  ...
  subtitle: "Tous tes achats disponibles ici",
  readyText: "Ton ebook est prêt. Télécharge-le sur n'importe quel appareil.",
  btnText: "⬇ Télécharger l'ebook",
  disabledMessage: "Contacte le support pour récupérer ton ebook."
};

/* ── REDIRECTION (bon de commande externe) ── */
var REDIR = {
  active: false,
  links: {} /* { [packId]: { noBundle: 'https://...', withBundle: 'https://...' } } */
};
...
var legalData = {
  ...
  retract: 14,
  guarantee: 365,
  payment: "Stripe (stripe.com) — données bancaires non stockées par Jenafans",
  ...
  liability: "Jenafans ne saurait être tenu responsable des résultats obtenus par l'utilisation de ses produits. Les résultats varient selon les individus."
};
